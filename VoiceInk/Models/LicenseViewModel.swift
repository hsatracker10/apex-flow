...
class LicenseViewModel: ObservableObject {
    ...
    private func loadLicenseState() {
        ...
        if let storedLicenseKey = licenseManager.licenseKey {
            ...
            if licenseManager.activationId != nil || !userDefaults.bool(forKey: "ApexFlowLicenseRequiresActivation") {
                licenseState = .licensed
        ...
        let hasLaunchedBefore = userDefaults.bool(forKey: "ApexFlowHasLaunchedBefore")
        if !hasLaunchedBefore {
            // First launch - start trial automatically
            userDefaults.set(true, forKey: "ApexFlowHasLaunchedBefore")
            startTrial()
            return
        }
    ...
    func validateLicense() async {
        ...
        do {
            ...
            if licenseCheck.requiresActivation {
                ...
                userDefaults.set(true, forKey: "ApexFlowLicenseRequiresActivation")
                ...
                userDefaults.set(false, forKey: "ApexFlowLicenseRequiresActivation")
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "ApexFlowLicenseRequiresActivation")
        userDefaults.set(false, forKey: "ApexFlowHasLaunchedBefore")  // Allow trial to restart
        userDefaults.activationsLimit = 0
...
extension UserDefaults {
    var activationsLimit: Int {
        get { integer(forKey: "ApexFlowActivationsLimit") }
        set { set(newValue, forKey: "ApexFlowActivationsLimit") }
    }
}
