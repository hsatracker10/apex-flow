    ...
    init() {
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "Apex Flow couldn't access its storage location. Your transcriptions will not be saved between sessions."
                ...
                ContentView()
                    ...
                    .onAppear {
                        ...
                        if containerInitializationFailed {
                            ...
                            alert.informativeText = "Apex Flow cannot initialize its storage system. The app cannot continue.\n\nPlease try reinstalling the app or contact support if the issue persists."
...
class UpdaterViewModel: ObservableObject {
    ...
    init() {
        ...
        // [HARDENED BUILD] Automatic update checks disabled for privacy.
        // Manual "Check for Updates…" in the menu still works on user request.
    ...
    func silentlyCheckForUpdates() {
        // [HARDENED BUILD] Silent background update check disabled for privacy.
        // User can still trigger a manual check via Help → Check for Updates…
    }
}
