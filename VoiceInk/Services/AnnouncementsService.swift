...
final class AnnouncementsService {
    ...
    private let announcementsURL = URL(string: "https://beingpax.github.io/Apex Flow/announcements.json")!
    ...
    func start() {
        // [HARDENED BUILD] Remote announcement fetch disabled for privacy.
        // The original implementation fetched https://beingpax.github.io/Apex Flow/announcements.json
        // on launch and every 4 hours. No network call is made in this build.
    }
