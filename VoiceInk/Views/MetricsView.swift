        ...
        VStack {
            ...
            if case .trial(let daysRemaining) = licenseViewModel.licenseState {
                TrialMessageView(
                    ...
                    onAddLicenseKey: {
                        // Post notification to navigate to Apex Flow Pro tab
                        NotificationCenter.default.post(
                            name: .navigateToDestination,
                            object: nil,
                            userInfo: ["destination": "Apex Flow Pro"]
                        )
                    }
                )
                .padding()
                ...
                TrialMessageView(
                    message: "Your trial has expired. Upgrade to continue using Apex Flow",
                    type: .expired,
                    onAddLicenseKey: {
