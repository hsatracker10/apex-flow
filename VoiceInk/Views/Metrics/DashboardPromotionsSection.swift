...
struct DashboardPromotionsSection: View {
    ...
    var body: some View {
        // [HARDENED BUILD] Upgrade and affiliate promotion banners removed.
        // Original implementation showed "Share & Unlock 30% OFF" and
        // "Earn With The Apex Flow Affiliate Program" cards in the dashboard.
        EmptyView()
    }
